            ...
            <div className="AllSlide">
                ...
                <Slider {...settings}>
                    <div className="firstDivSlide">
                        ...
                        <br />
                        <span className="titleBott">златоусовских ножей</span>
                        <br />
                        <span className="allDescription">
                            <span className="descriptionSlider">
                                Добро пожаловать на официальный сайт «ЗЛАТМАКС»!
                                В нашем магазине{" "}
                            </span>
                            <br />
                            представлен наиболее широкий выбор Златоустовских
                            ножей от Златоустовских <br />
                            Оружейных Фабрик и компаний, мы являемся
                            официальными поставщиками.
                        </span>
                        <a href="#" className="TitleButton">
                            Подробнее
                        </a>
                    </div>
                    <div className="firstDivSlide">
